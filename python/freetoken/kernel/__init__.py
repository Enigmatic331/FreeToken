...
# Isolated source worktrees can reuse the ABI-matched native extensions built by the
# installed/base worktree without copying binaries into source control.
